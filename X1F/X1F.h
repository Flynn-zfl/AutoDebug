...
///////////////////////////////////////////////////////////////////////////
static unsigned short Chip_crc16tab_Burn[256] = {
...
int OVChipInitReadSF(int nSlaveID);
int OVChipInitRam(int nSlaveID);
int OVChipRunRam(int nSlaveID);
void OVChipReboot(int slaveID);
...
BOOL SendFwRam_Chip(unsigned nID, unsigned int nSect, unsigned int nFWoffset, unsigned char *pBuf);
